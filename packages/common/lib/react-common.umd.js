(function (global, factory) {
  ...
  function getApolloContext(client) {
    if (!apolloContext) {
      var defaultContext = client ? {
        client: client
      } : {};
      apolloContext = _react.default.createContext(defaultContext);
    }
  ...
  var ApolloProvider = function (_a) {
    ...
    var ApolloContext = getApolloContext(client);
